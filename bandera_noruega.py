...
frame_amarillo.config(bg="snow", width=500, height=500)
frame_amarillo.place(x=0 , y=190)
...
#-------------------------
frame_rojo=Frame(ventana_principal)
frame_rojo.config(bg="snow", width=100, height=500)
frame_rojo.place(x=110 , y=0)

#-------------------------
#frame rojo-----------
#-------------------------
frame_rojo=Frame(ventana_principal)
frame_rojo.config(bg="navy", width=45, height=500)
frame_rojo.place(x=136 , y=0) 

#-------------------------
#frame rojo-----------
#-------------------------
frame_rojo=Frame(ventana_principal)
frame_rojo.config(bg="navy", width=500, height=40)
frame_rojo.place(x=0 , y=230) 
